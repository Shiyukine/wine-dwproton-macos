...
@ stdcall -arch=!i386 KeAcquireQueuedSpinLock(long)
@ stdcall -arch=!i386 KeReleaseQueuedSpinLock(long long)
@ stdcall -arch=!i386 KeQueryPrcbAddress(long)
@ stdcall -arch=!i386 IoUnregisterPlugPlayNotificationEx(ptr)
